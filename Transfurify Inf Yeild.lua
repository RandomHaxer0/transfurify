...
game:GetService("RunService").RenderStepped:connect(function()
    if (game:GetService("Players").LocalPlayer.Character.Sprinting) then
        if (game:GetService("Players").LocalPlayer.Character.JumpCooldown) then
            if (game:GetService("Players").LocalPlayer.Character.Head.NameTag) then
                if (game:GetService("Players").LocalPlayer.Character.TiltSpeedDetection) then
                    if (game:GetService("Players").LocalPlayer.Character.TiltFolder) then
                        if (game:GetService("Players").LocalPlayer.Character["Anti-Tp"]) then
...
CMDs[#CMDs + 1] = {NAME = 'fesp / furryesp', DESC = 'Furry Esp'}
CMDs[#CMDs + 1] = {NAME = 'gunm2 / gunmethod2', DESC = 'Gun Grabber Method 2'}
CMDs[#CMDs + 1] = {NAME = 'sledgem2 / sledgemethod2', DESC = 'Sledge Hammer Method 2'}
CMDs[#CMDs + 1] = {NAME = 'g / gun', DESC = 'Gun Grabber'}
CMDs[#CMDs + 1] = {NAME = 'sledge / sledgehammer', DESC = 'SledgeHammer Grabber'}
CMDs[#CMDs + 1] = {NAME = 'agrab / antigrab', DESC = 'Anti Grab'}
CMDs[#CMDs + 1] = {NAME = 'bozo / bozodetect', DESC = 'Bozo Detector (Not Accurate)'}
CMDs[#CMDs + 1] = {NAME = 'door / nodoor', DESC = 'Removes Doors'}
CMDs[#CMDs + 1] = {NAME = 'kat / katana', DESC = 'Katana Grabber'}
CMDs[#CMDs + 1] = {NAME = 'irnfect', DESC = 'Infects You, Infects Selected Target, Resets, Brings Back To Original Position'}
CMDs[#CMDs + 1] = {NAME = 'iinfect', DESC = 'Infects You, Infects Selected Target'}
CMDs[#CMDs + 1] = {NAME = 'nfect', DESC = 'Infects Selected Target (Make Sure Your Infected)'}
CMDs[#CMDs + 1] = {NAME = 'a / aura', DESC = 'Run Kill/Infect Aura'}
CMDs[#CMDs + 1] = {NAME = 'sa / stopaura', DESC = 'Stop Kill/Infect Aura'}
CMDs[#CMDs + 1] = {NAME = 'mgun / modgun', DESC = 'Mods Gun (Equip Gun First And Gun Must Be On Full Mag)'}
CMDs[#CMDs + 1] = {NAME = 'msledge / modsledge', DESC = 'Mods Sledge (Equip First)'}
CMDs[#CMDs + 1] = {NAME = 'mkatana / modkatana', DESC = 'Mods Katana (Equip First)'}
CMDs[#CMDs + 1] = {NAME = 'gui', DESC = 'Executes My Transfurify Gui'}
wait()
...
addcmd('fesp',{'furryesp'},function(args, speaker)
...
for i,v in pairs(game.Players:GetChildren()) do
    ...
    function boxesp()
        game:GetService("RunService").RenderStepped:Connect(function()
            if v.Character ~= nil and v.Character:FindFirstChild("Transformed") ~= nil and v.Character:FindFirstChild("Humanoid") ~= nil and v.Character:FindFirstChild("HumanoidRootPart") ~= nil and v ~= lplr and v.Character.Humanoid.Health > 0 then
...
addcmd("gunm2",{"gunmethod2"},function(args, speaker)
        if (game.Workspace.Scripted.Interactable["Five-SeveN"]) then
        notification("Five-SeveN Found, Five-SeveN Grabber Method 2 Runned")
            local msg1 = Instance.new("Message", game.Workspace)
            msg1.Text = "DONT TOUCH ANYTHING OR THIS CMD WONT EQUIP AND MOD THE GUN"
pos2 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position

game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game.Workspace.Scripted.Interactable["Five-SeveN"].BasePart.Position)

wait(1)

local proximityprompt = game.Workspace.Scripted.Interactable["Five-SeveN"].BasePart.Attachment.GiveItem

fireproximityprompt(proximityprompt, 4, false)
wait(2)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos2)

local tool = game:GetService("Players").LocalPlayer.Backpack["Five-SeveN"]
...
local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Five-SeveN [12]"].Setting)
...
for i,v in next, req do
   ...
   req.MaxAmmo = 2000
   req.Firerate = 0
   req.MultipleBullet = 50
end
notification("Five-SeveN Grabbed, Equipped And Modified")

end
    
end)

addcmd("sledgem2",{"sledgemethod2"},function(args, speaker)
    if (game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"].Part) then
    notification("Sledge Hammer Found, Sledge Hammer Grabber Method 2 Runned")
for i,v in pairs(game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"]:GetDescendants()) do
        if v.Name == "GiveItem" then
            local msg = Instance.new("Message", game.Workspace)
            msg.Text = "DONT TOUCH ANYTHING OR THIS CMD WONT EQUIP AND MOD THE SLEDGE HAMMER"
            pos5 = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position
            wait()
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"].Part.Position)
            wait(1)
            fireproximityprompt(v,4,false)
            wait(2)
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos5)
            wait()
            local tool = game:GetService("Players").LocalPlayer.Backpack["Sledge Hammer"]
            game:GetService("Players").LocalPlayer.Character.Humanoid:EquipTool(tool)
            wait()
            msg:Destroy()
local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Sledge Hammer"].Setting)
...
addcmd("g",{"gun"},function(args, speaker)
        if (game.Workspace.Scripted.Interactable["Five-SeveN"]) then
        notification("Five-SeveN Found, Five-SeveN Grabber Runned")
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos2)
wait(0.1)
notification("Grabbed The Gun")
end
end)

addcmd("sledge",{"sledgehammer"},function(args, speaker)
            if (game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"]) then
        notification("Sledge Found, Sledge Grabber Runed")
pos5 = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position
...
notification("Grabbed Sledge")
end
end)

addcmd("agrab",{"antigrab"},function(args, speaker)
       notification("Anti-Grab Runned (Dont Run Twice Cause Of Lag)")
game:GetService("RunService").RenderStepped:Connect(function()
local Event = game:GetService("Players").LocalPlayer.PlayerGui.SpaceToRelease.RemoteEvent
Event:FireServer()
end)
end)

addcmd("bozo",{"bozodetect"},function(args, speaker)
        local plr = game.Players.LocalPlayer

game.Players.PlayerAdded:Connect(function(hit)
if hit:GetRankInGroup(7214173) > 1 or hit.Character["Kill Count"].Value > 400 or hit.Character["Infect Count"].Value > 400 then
  plr:Kick("A No Life Furry Mod Joined But We Kicked You So That The Bozo Cant Ban You")
end
end)
end)

addcmd("door",{"nodoor"},function(args, speaker)
   for i,v in pairs(game:GetService("Workspace").Door:GetDescendants()) do
...
addcmd("kat",{"katana"},function(args, speaker)
        if (game.Workspace.Scripted.Interactable.Katana.Katana) then
notify("Katana Found, Katana Grabber Runned")
local player = game.Players.LocalPlayer
local chare = player.Character
local proximity = game.Workspace.Scripted.Interactable.Katana.Katana.Attachment.ProximityPrompt
local proximity2 = game.Workspace.Scripted.Interactable.Katana.Katana.GiveItem
pos8 = chare.HumanoidRootPart.Position
wait(0.1)
chare.HumanoidRootPart.CFrame = CFrame.new(game.Workspace.Scripted.TransformBrick.ps.Position)
wait(9)
chare.HumanoidRootPart.CFrame = CFrame.new(game.Workspace.Scripted.Interactable.Katana.Katana.Position)
wait(1)
fireproximityprompt(proximity, 8, false)
wait(2)
...
wait(1)
fireproximityprompt(proximity2, 5, false)
wait(3)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos8)
notification("Grabbed Katana")
end
end)

addcmd("irnfect",{},function(args, speaker)
            local plr = psearch(args[1])

	    if (plr.leaderstats["Current Side"].Value == "Human") then
	      
local localplayer = game:GetService("Players").LocalPlayer
local character = localplayer.Character
local timer = 0
local crystal = game:GetService("Workspace").Scripted.TransformBrick.ps
pos256 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
wait(0.45)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(crystal.Position)
wait(7)
wait(2)
        local tool = game.Players.LocalPlayer.Backpack.Grab
...
Stepped = game:GetService("RunService").RenderStepped:Connect(function()
    pcall(function()
        local tool2 = game.Players.LocalPlayer.Character.Grab
        tool2:Activate()
        timer = timer + 1
        game:service("Players").LocalPlayer.Character.Humanoid:ChangeState(11)
        game:service("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = plr.Character.HumanoidRootPart.CFrame * CFrame.Angles(math.rad(-90), 0, 0) + Vector3.new(0, 4, 0)
    end)
    if plr.Character.Grabbed or character.Humanoid.Health == 0 or timer == 150 or plr.leaderstats["Current Side"].Value == "Entity" then
        character.HumanoidRootPart.CFrame = CFrame.new(-24.3757, 3.70316, -267.986)
        Stepped:Disconnect()
    end
    wait(1)
game.Players.LocalPlayer.Character.Humanoid.Name = 1
...
game.Players.LocalPlayer.Character=prt
wait(6.2)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(162.965469, 1.25, -116.620926, 0.501632452, -1.08123338e-07, 0.865080833, 7.31046157e-08, 1, 8.25953848e-08, -0.865080833, 2.18088783e-08, 0.501632452)
wait(3)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos256)
wait(1)
local dog3 = game.Players.LocalPlayer.Character.Grab
game.Players.LocalPlayer.Character.Humanoid:UnequipTools(dog3)
end)
end
end)

addcmd("iinfect",{},function(args, speaker)
            local plr = psearch(args[1])
...
pos256 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
wait(0.45)
character.HumanoidRootPart.CFrame = CFrame.new(crystal.Position)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos256)
wait(1)
local dog2 = game.Players.LocalPlayer.Character.Grab
game.Players.LocalPlayer.Character.Humanoid:UnequipTools(dog2)
end)
end
end) 

addcmd("nfect",{},function(args, speaker)
                local plr = psearch(args[1])

	    if (plr.leaderstats["Current Side"].Value == "Human") then
	        if (game.Players.LocalPlayer.leaderstats["Current Side"].Value == "Entity") then
...
Stepped = game:GetService("RunService").RenderStepped:Connect(function()
    ...
    if plr.leaderstats["Current Side"].Value == "Entity" or plr.Character.Grabbed or timer == 150 or character.Humanoid.Health == 0 then
        character.HumanoidRootPart.CFrame = CFrame.new(-24.3757, 3.70316, -267.986)
        Stepped:Disconnect()
    end
wait(3)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(pos256)
wait(1)
local dog = game.Players.LocalPlayer.Character.Grab
game.Players.LocalPlayer.Character.Humanoid:UnequipTools(dog)
end)
end
end
end)

addcmd("a",{"aura"},function(args, speaker)
    notify("Aura Runned")
...
while _G.gnb do wait(0.1)
    for i, v in pairs(game:GetService("Players"):GetChildren()) do
        if v and v.Character then
            ...
            game:GetService("ReplicatedStorage").Remote.Weapon.Use:FireServer(character["Torso"])
...
addcmd("sa",{"stopaura"},function(args, speaker)
    notify("Stopped Aura")
    _G.gnb = false
end)

addcmd("mgun",{"modgun"},function(args, speaker)
        notify("Make Sure Your Gun Is Equipped And Has A Full Mag")
...
notify("Moded The Gun")
end)

addcmd("msledge",{"modsledge"},function(args, speaker)
        
    notify("Make Sure Sledge Is Equipped")
...
addcmd("mkatana",{"modkatana"},function(args, speaker)
        
    notify("Make Sure Katana Is Equipped")
    
local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Katana"].Setting)
...
addcmd("gui",{},function(args, speaker)
    local library = loadstring(game:HttpGet(('https://raw.githubusercontent.com/AikaV3rm/UiLib/master/Lib.lua')))()

local w = library:CreateWindow("Transfurify") -- Creates the window

local b = w:CreateFolder("Grabbers")
local d = w:CreateFolder("Modifications")
local e = w:CreateFolder("Player")
...
b:Button("Gun Method 2",function()
        if (game.Workspace.Scripted.Interactable["Five-SeveN"]) then
        notification("Five-SeveN Found, Five-SeveN Grabber Method 2 Runned")
            local msg1 = Instance.new("Message", game.Workspace)
            msg1.Text = "DONT TOUCH ANYTHING OR THIS CMD WONT EQUIP AND MOD THE GUN"
...
b:Button("Sledge Method 2",function()
if (game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"].Part) then
    notification("Sledge Hammer Found, Sledge Hammer Grabber Method 2 Runned")
for i,v in pairs(game:GetService("Workspace").Scripted.Interactable["Sledge Hammer"]:GetDescendants()) do
        if v.Name == "GiveItem" then
...
b:Button("Katana",function()
    if (game.Workspace.Scripted.Interactable.Katana.Katana) then
notification("Katana Found, Katana Grabber Runned")
local player = game.Players.LocalPlayer
local chare = player.Character
local proximity = game.Workspace.Scripted.Interactable.Katana.Katana.Attachment.ProximityPrompt
local proximity2 = game.Workspace.Scripted.Interactable.Katana.Katana.GiveItem
...
d:Button("ModGun",function()
        notification("Make Sure You Equip Gun First And That Your Gun Has A Full Mag")
...
notification("Moded The Gun")
end)

d:Button("ModSledge",function()
        notification("Make Sure Sledge Is Equipped")
...
notification("Moded Sledge")
end)

d:Button("ModBat",function()
    notification("Make Sure Bat Is Equipped")
    
    local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Bat"].Setting)
...
for i,v in next, req do
      ...
      req.PrepareTime = 0
      req.Cooldown = 0
       req.SwingSoundDelay = 0
      req.Debug = false
       req.CustomAttack = nil
end
notification("Moded Bat")
end)

d:Button("ModKatana",function()
    notification("Make Sure Katana Is Equipped")
...
notification("Moded Katana")
end)

d:Button("ModAttack",function()
    notification("Make Sure Attack Is Equipped")
 
    local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Attack"].Setting)
...
d:Button("ModGrab",function()
    notification("Make Sure Grab Is Equipped")

    local req = require(game.Workspace[game.Players.LocalPlayer.Name]["Grab"].Setting)
...
e:Button("Reset",function()
        notification("Resseting Character...")
game.Players.LocalPlayer.Character.Humanoid.Name = 1
local l = game.Players.LocalPlayer.Character["1"]:Clone()
l.Parent = game.Players.LocalPlayer.Character
l.Name = "Humanoid"
...
wait(6.2)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Location
notification("Reseted Character")
end)

e:Button("Self Infect",function()
        notification("Infecting Character..")
    local hum = game.Players.LocalPlayer.Character.HumanoidRootPart
    local crystal = game.Workspace.Scripted.TransformBrick.ps
    pos91 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
    hum.CFrame = CFrame.new(crystal.Position)
    wait(7)
    hum.CFrame = CFrame.new(pos91)
    notification("Character Infected")
end)
...
s:Button("No Infect",function()
        notification("Removing All Cum Puddles, Kill Barriers And Crystals Except 1 Crystal...")
for i,v in pairs(game:GetService("Workspace").Scripted.TransformBrick:GetDescendants()) do
        if v.Name == "BlackContainer" or v.Name == "Crystal" or v.Name == "BlackPool" or v.Name == "StraightMovementShark" or v.Name == "CurveMovementShark" or v.Name == "SpawnWhirlPool" or v.Name == "WhitePillars" or v.Name == "Part" or v.Name == "UnnamedStain" or v.Name == "Cone" then
        v:Destroy()
    end
end
...
for s,v in pairs(game:GetService("Workspace").Scripted.TransformArea:GetDescendants()) do
        if v.ClassName == "Part" or "Model" or "MeshPart" then
        v:Destroy()
    end
end
...
for g,v in pairs(game:GetService("Workspace").Scripted.TransformSpecial:GetDescendants()) do
        if v.ClassName == "Part" or "Model" or "MeshPart" then
        v:Destroy()
    end
end
...
for r,v in pairs(game:GetService("Workspace").Scripted.KillBarrier:GetDescendants()) do
        if v.ClassName == "Part" or "Model" or "MeshPart" then
        v:Destroy()
    end
end
notification("Removed All Cum Puddles, Kill Barriers And Crystals Except 1 Crystal")
end)

s:Button("No Doors",function()
    for i,v in pairs(game:GetService("Workspace").Door:GetDescendants()) do
    if v.ClassName == "Model" then
        v:Destroy()
    end
...
local presskeytoaim = true; local aimkey = "f"
...
f:Button("Aura On",function()
    notification("Aura Runned")
